 ...
 *
 * Quotes crossfade inside a fixed-height card. Same motion rules as the hero:
 * it stops for reduced motion, for the pointer, and for a hidden tab.
 */
      ...
      <div className="relative min-h-[210px]">
        {items.map((review, i) => (
          <figure
            key={review.quote}
            aria-hidden={i !== index}
            className="absolute inset-0 m-0 flex flex-col justify-center transition-opacity duration-[600ms] ease-linear"
