...
const fieldClass =
  "w-full rounded-[var(--sz-radius-btn-lg)] border bg-canvas px-3.5 text-control text-heading outline-none min-h-12 transition-[border-color] duration-[var(--sz-dur)] ease-[var(--sz-ease-out)] focus-visible:border-accent";
